...
vim.g.VM_maps = {
	...
	["Add Cursor Down"] = "<C-Alt-Down>", -- Add a new cursor below (like VS Code)
	["Add Cursor Up"] = "<C-Alt-Up>", -- Add a new cursor above (like VS Code)
}
...
require("lazy").setup({
	...
	},
	{
		...
		config = function()
			...
			-- Set keybinding for block comments
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			require("nvim-tree").setup({
				sync_root_with_cwd = true, -- Sync NvimTree with `cd`
				respect_buf_cwd = true, -- Use buffer directory as root
				update_focused_file = {
					enable = true,
